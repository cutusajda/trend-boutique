        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="border-b border-gray-200 pb-14 flex justify-between items-center flex-col gap-8 lg:gap-0 lg:flex-row">
            ...
            <div className="flex items-center flex-col gap-8 md:gap-2 lg:flex-row">
              ...
              />
              <button className="btn md:h-14 py-4 px-8 bg-everglade hover:bg-darkSpringGreen rounded-full text-white font-bold">
                Subscribe
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 min-[690px]:grid-cols-4 lg:grid-cols-6 gap-4 xl:gap-8 pt-14 pb-10 max-w-xs mx-auto min-[690px]:max-w-2xl lg:max-w-full">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0 text-center md:text-start">
              <Link
                href={""}
              ...
              <a
                href=""
                className="btn w-fit bg-everglade hover:bg-darkSpringGreen rounded-full text-white px-8"
              >
                Contact us
              </a>
            </div>
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-gray-500 ">
                ©<a href="https://pagedone.io/">Trend Botique</a>2024, All
                rights reserved.
              </span>
